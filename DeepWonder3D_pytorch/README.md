...
Optional: enable rigid single-view motion correction before the selected mode:
- `single_view_motion_correction=True`
- `mc_max_shift=15` (pixel clipping threshold for frame shifts)
